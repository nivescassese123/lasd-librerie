...
public:
  ...
  template <typename Accumulator>
  inline Accumulator Fold(FoldFun<Accumulator> func,Accumulator ac) const;
...
public:
  ...
  virtual void PreOrderTraverse(const TraverseFun) const = 0; // Override TraversableContainer member 
...
public:
  ...
  virtual void PostOrderTraverse(TraverseFun) const = 0; // Override TraversableContainer member
